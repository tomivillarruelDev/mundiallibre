...
export function triggerGoalCelebration() {
    ...
    if (typeof confetti !== "undefined") {
        ...
        fire(0.35, { spread: 100, decay: 0.91, scalar: 0.8, origin: { x: 0.1, y: 0.85 } });
        fire(0.1, { spread: 120, startVelocity: 25, decay: 0.92, scalar: 1.2, origin: { x: 0.1, y: 0.85 } });
        ...
        fire(0.35, { spread: 100, decay: 0.91, scalar: 0.8, origin: { x: 0.9, y: 0.85 } });
        fire(0.1, { spread: 120, startVelocity: 25, decay: 0.92, scalar: 1.2, origin: { x: 0.9, y: 0.85 } });
    ...
    if (typeof gsap !== "undefined") {
        ...
        tl.fromTo(goalOverlay, { opacity: 0 }, { opacity: 1, duration: 0.25 })
          .fromTo(".goal-text-glow", { scale: 0.3, y: 80, rotation: -10 }, { scale: 1.1, y: 0, rotation: 0, duration: 0.5, ease: "back.out(1.8)" })
